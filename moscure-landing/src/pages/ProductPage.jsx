...
function ProductCard({ product, onNavigate }) {
  ...
  return (
    <motion.a
      ...
      whileHover={{ y: -6 }}
      className="animated-border h-full block cursor-pointer group"
    >
      <div className="bg-surface rounded-2xl overflow-hidden flex flex-col h-full">
        ...
        <div className="flex flex-col gap-4 p-5 flex-1">
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full py-3 rounded-full font-mono text-sm font-bold text-background transition-shadow block text-center mt-auto"
...
function VideoTestimonials() {
  // We use the ID provided by the user. Let me know if you want to add more from the playlist!
  const videoIds = ['IaXg1IM96S0', 'SfP9ZsH0Sf4', 'BXlIOvM3LpE', 'GaSK2J-HMy4', 'ddaxKgiJzOY', 'uO3goxBOjOM']
